Shader "Paint/PaintStandard" {
	Properties{
		...
		_SplatColor1("Splat Color 1", Color) = (0.09, 0.43, 0.46, 1.0)
		_SplatColor2("Splat Color 2", Color) = (0.29, 0.14, 0.31, 1.0)
		_SplatColor3("Splat Color 3", Color) = (0.76, 0.27, 0.14, 1.0)
